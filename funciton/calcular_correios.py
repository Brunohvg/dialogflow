...
def calcular_correio(dados):
    ...
    sedex = [response_dic['servicos']['04162']['Valor'], int(response_dic['servicos']['04162']['PrazoEntrega'])]
    pac = [response_dic['servicos']['04669']['Valor'], int(response_dic['servicos']['04162']['PrazoEntrega'])]

    if sedex[0] > pac[0]:
        fulfillment_text = f"Olá, o valor estimado do SEDEX é R$ {sedex[0]}, com tempo médio de {sedex[1]} dias. O valor estimado do PAC é R$ {pac[0]}, com tempo médio de {pac[1]} dias.\nLembre-se o tempo de entrega pode variar diacordo com o dia em que foi postado"
    else:
        fulfillment_text = f"Olá, o valor estimado do SEDEX é R$ {sedex[0]}, com tempo médio de {sedex[1]} dias.\nNão fazemos PAC para sua Região.\nLembre-se o tempo de entrega pode variar diacordo com o dia em que foi postado"
